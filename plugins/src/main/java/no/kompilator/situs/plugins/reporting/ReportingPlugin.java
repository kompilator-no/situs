package no.kompilator.situs.plugins.reporting;
...
import no.kompilator.situs.plugin.TestFrameworkPlugin;
...
public class ReportingPlugin implements TestFrameworkPlugin, SuiteRunListener {
    ...
    /**
     * Called automatically by {@link no.kompilator.situs.service.TestFrameworkService}
