 ...
 *
 * @see ReportingPlugin
 * @see no.certusdev.testframework.javalibrary.plugin.PluginRunner
 */
@AutoConfiguration
...
public class ReportingAutoConfiguration {
     ...
     *
     * <p>The plugin is registered as a {@link no.certusdev.testframework.javalibrary.plugin.SuiteRunListener}
