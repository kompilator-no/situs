package no.certusdev.testframework.kotlinapp
 ...
 * This sample scopes discovery to `no.certusdev.testframework.kotlinapp.tests` instead of
 ...
 * See [no.certusdev.testframework.kotlinapp.tests.CalculatorTestSuite] for an example.
 *
 * ## HTTP API
