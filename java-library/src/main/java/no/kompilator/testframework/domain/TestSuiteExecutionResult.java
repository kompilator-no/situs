 ...
 * {@link no.kompilator.testframework.runtime.RuntimeTestSuiteRunner#runSuite(Class)}
 * after all tests in a suite have finished. It is not part of the public API — the
 * public counterpart is {@link no.kompilator.testframework.model.TestSuiteResult}.
 *
