 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.testframework.model}) which
 * has no Spring dependency and can be used in any context.
 *
 * <p>Returned by {@link no.kompilator.testframework.service.TestFrameworkService#getAllSuites()}
 * and accepted as a JSON request body by the
 * {@link no.kompilator.testframework.spring.TestFrameworkController} run endpoints.
