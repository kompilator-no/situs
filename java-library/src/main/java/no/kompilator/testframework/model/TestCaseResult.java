 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.testframework.model}) used by
 * both the pure-Java runtime ({@link no.kompilator.testframework.runtime.TestRunner})
 * and higher-level API layers ({@link no.kompilator.testframework.model.SuiteRunStatus}).
 *
