 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.testframework.model}).
 * Produced by {@link no.kompilator.testframework.runtime.RuntimeTestSuiteRunner#runSuite(Class)}
 * and also constructed by {@link no.kompilator.testframework.service.TestFrameworkService}
