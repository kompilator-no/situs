...
import no.kompilator.testframework.plugin.PluginRunner;
 ...
 *   <li>{@link PluginRunner} — discovers all {@link no.kompilator.testframework.plugin.TestFrameworkPlugin}
...
public class RuntimeTestAutoConfiguration {
     ...
     * {@link no.kompilator.testframework.plugin.TestFrameworkPlugin} beans in the
