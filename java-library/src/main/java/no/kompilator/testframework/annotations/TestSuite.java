package no.kompilator.testframework.annotations;
 ...
 * {@link no.kompilator.testframework.runtime.ClasspathScanner#findAllTestSuites()}
 * (full classpath scan) or
 * {@link no.kompilator.testframework.runtime.ClasspathScanner#findTestSuites(String)}
 * (package-scoped scan), and then registered with
 * {@link no.kompilator.testframework.runtime.TestSuiteRegistry}.
 ...
 *
 * @see Test
 * @see no.kompilator.testframework.runtime.TestSuiteRegistry
 * @see no.kompilator.testframework.runtime.ClasspathScanner
 */
