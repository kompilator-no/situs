 ...
 * {@link no.kompilator.javalibrary.runtime.ClasspathScanner#findAllTestSuites()}
 * (full classpath scan) or
 * {@link no.kompilator.javalibrary.runtime.ClasspathScanner#findTestSuites(String)}
 * (package-scoped scan), and then registered with
 * {@link no.kompilator.javalibrary.runtime.TestSuiteRegistry}.
 ...
 *
 * @see Test
 * @see no.kompilator.javalibrary.runtime.TestSuiteRegistry
 * @see no.kompilator.javalibrary.runtime.ClasspathScanner
 */
