 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.javalibrary.model}) used by
 * both the pure-Java runtime ({@link no.kompilator.javalibrary.runtime.TestRunner})
 * and higher-level API layers ({@link no.kompilator.javalibrary.model.SuiteRunStatus}).
 *
