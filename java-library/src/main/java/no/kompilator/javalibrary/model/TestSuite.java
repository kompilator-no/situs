 ...
 *
 * <p>Returned by {@link no.kompilator.javalibrary.service.TestFrameworkService#getAllSuites()}
 * and accepted as a JSON request body by the
 * {@link no.kompilator.javalibrary.spring.TestFrameworkController} run endpoints.
