 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.javalibrary.model}).
 * Produced by {@link no.kompilator.javalibrary.runtime.RuntimeTestSuiteRunner#runSuite(Class)}
 * and also constructed by {@link no.kompilator.javalibrary.service.TestFrameworkService}
