 ...
 * <p>Responsible for:
 * <ul>
 *   <li>Discovering lifecycle methods ({@link no.kompilator.javalibrary.annotations.BeforeAll @BeforeAll},
 *       {@link no.kompilator.javalibrary.annotations.BeforeEach @BeforeEach},
 *       {@link no.kompilator.javalibrary.annotations.AfterEach @AfterEach},
 *       {@link no.kompilator.javalibrary.annotations.AfterAll @AfterAll}) and test methods
 *       ({@link no.kompilator.javalibrary.annotations.Test @Test})
 ...
 * @see no.kompilator.javalibrary.service.TestFrameworkService
 */
public class TestRunner {
     ...
     * (e.g. pass a {@link no.kompilator.javalibrary.spring.SpringInstanceFactory}).
     *
