 ...
 * {@link no.kompilator.javalibrary.runtime.RuntimeTestSuiteRunner#runSuite(Class)}
 * after all tests in a suite have finished. It is not part of the public API — the
 * public counterpart is {@link no.kompilator.javalibrary.model.TestSuiteResult}.
 *
