 ...
 * {@link no.testframework.javalibrary.runtime.ClasspathScanner#findAllTestSuites()}
 * (full classpath scan) or
 * {@link no.testframework.javalibrary.runtime.ClasspathScanner#findTestSuites(String)}
