 ...
 *
 * <p>Scans each candidate class for the {@link no.testframework.javalibrary.annotations.TestSuite @TestSuite}
 * annotation. For every annotated class it reads all methods carrying
 * {@link no.testframework.javalibrary.annotations.Test @Test}
