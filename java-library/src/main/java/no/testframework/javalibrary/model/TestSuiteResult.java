 ...
 *
 * <p>Part of the shared model layer ({@code no.testframework.javalibrary.model}).
 * Produced by {@link no.testframework.javalibrary.runtime.RuntimeTestSuiteRunner#runSuite(Class)}
 * and also constructed by {@link no.testframework.javalibrary.service.TestFrameworkService}
