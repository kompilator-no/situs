 ...
 *
 * <p>Part of the shared model layer ({@code no.certusdev.testframework.javalibrary.model}).
 * Produced by {@link no.certusdev.testframework.javalibrary.runtime.RuntimeTestSuiteRunner#runSuite(Class)}
 * and also constructed by {@link no.certusdev.testframework.javalibrary.service.TestFrameworkService}
