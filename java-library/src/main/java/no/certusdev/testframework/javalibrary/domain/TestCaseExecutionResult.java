 ...
 * {@link no.certusdev.testframework.javalibrary.runtime.TestRunner} after each test method runs
 * (or fails/times out). It is not part of the public API — the public counterpart is
 * {@link no.certusdev.testframework.javalibrary.model.TestCaseResult}.
 *
