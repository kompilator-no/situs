...
import no.certusdev.testframework.javalibrary.plugin.PluginRunner;
 ...
 *   <li>{@link PluginRunner} — discovers all {@link no.certusdev.testframework.javalibrary.plugin.TestFrameworkPlugin}
...
public class RuntimeTestAutoConfiguration {
     ...
     * {@link no.certusdev.testframework.javalibrary.plugin.TestFrameworkPlugin} beans in the
