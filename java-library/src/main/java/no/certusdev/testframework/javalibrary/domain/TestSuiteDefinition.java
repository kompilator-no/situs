package no.certusdev.testframework.javalibrary.domain;
 ...
 * {@link no.certusdev.testframework.javalibrary.runtime.TestSuiteRegistry#getAllSuites(java.util.Set)}
 * and consumed by {@link no.certusdev.testframework.javalibrary.service.TestFrameworkService}
 * and {@link no.certusdev.testframework.javalibrary.runtime.TestRunner}.
 */
public class TestSuiteDefinition {
     ...
     *
     * @param name       display name (from {@code @TestSuite#name()}, or the class simple name)
