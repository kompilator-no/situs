 ...
 * <p>Responsible for:
 * <ul>
 *   <li>Discovering lifecycle methods ({@link no.certusdev.testframework.javalibrary.annotations.BeforeAll @BeforeAll},
 *       {@link no.certusdev.testframework.javalibrary.annotations.BeforeEach @BeforeEach},
 *       {@link no.certusdev.testframework.javalibrary.annotations.AfterEach @AfterEach},
 *       {@link no.certusdev.testframework.javalibrary.annotations.AfterAll @AfterAll}) and test methods
...
public class TestRunner {
     ...
     * (e.g. pass a {@link no.certusdev.testframework.javalibrary.spring.SpringInstanceFactory}).
     *
