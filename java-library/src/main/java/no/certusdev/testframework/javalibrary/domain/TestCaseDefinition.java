 ...
 *
 * <p>Holds all metadata that {@link no.certusdev.testframework.javalibrary.runtime.TestRunner}
...
public class TestCaseDefinition {
     ...
     *         ({@link no.certusdev.testframework.javalibrary.runtime.TestRunner#DEFAULT_TIMEOUT_MS}),
