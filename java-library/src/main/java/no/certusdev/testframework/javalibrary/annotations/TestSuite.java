package no.certusdev.testframework.javalibrary.annotations;
 ...
 * {@link no.certusdev.testframework.javalibrary.runtime.ClasspathScanner#findAllTestSuites()}
 * (full classpath scan) or
 * {@link no.certusdev.testframework.javalibrary.runtime.ClasspathScanner#findTestSuites(String)}
 * (package-scoped scan), and then registered with
 * {@link no.certusdev.testframework.javalibrary.runtime.TestSuiteRegistry}.
 ...
 *
 * @see Test
 * @see no.certusdev.testframework.javalibrary.runtime.TestSuiteRegistry
 * @see no.certusdev.testframework.javalibrary.runtime.ClasspathScanner
 */
