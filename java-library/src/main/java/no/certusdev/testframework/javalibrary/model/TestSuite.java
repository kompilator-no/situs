 ...
 *
 * <p>Part of the shared model layer ({@code no.certusdev.testframework.javalibrary.model}) which
 * has no Spring dependency and can be used in any context.
 *
 * <p>Returned by {@link no.certusdev.testframework.javalibrary.service.TestFrameworkService#getAllSuites()}
 * and accepted as a JSON request body by the
 * {@link no.certusdev.testframework.javalibrary.spring.TestFrameworkController} run endpoints.
