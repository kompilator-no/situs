 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.situs.model}) which
 * has no Spring dependency and can be used in any context.
 *
 * <p>Returned by {@link no.kompilator.situs.service.TestFrameworkService#getAllSuites()}
 * and accepted as a JSON request body by the
 * {@link no.kompilator.situs.spring.TestFrameworkController} run endpoints.
