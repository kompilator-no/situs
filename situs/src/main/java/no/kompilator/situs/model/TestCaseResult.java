 ...
 *
 * <p>Part of the shared model layer ({@code no.kompilator.situs.model}) used by
 * both the pure-Java runtime ({@link no.kompilator.situs.runtime.TestRunner})
 * and higher-level API layers ({@link no.kompilator.situs.model.SuiteRunStatus}).
 *
