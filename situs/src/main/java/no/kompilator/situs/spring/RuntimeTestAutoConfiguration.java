...
import no.kompilator.situs.plugin.PluginRunner;
...
/**
 * Spring {@code @Configuration} that registers the Situs beans into
 ...
 *   <li>{@link PluginRunner} — discovers all {@link no.kompilator.situs.plugin.TestFrameworkPlugin}
...
public class RuntimeTestAutoConfiguration {
     ...
     * @param properties Situs system integration testing configuration properties
     ...
     * {@link no.kompilator.situs.plugin.TestFrameworkPlugin} beans in the
