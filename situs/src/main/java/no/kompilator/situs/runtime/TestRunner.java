...
/**
 * Core execution engine for Situs system integration tests.
 *
 * <p>Responsible for:
 * <ul>
 *   <li>Discovering lifecycle methods ({@link no.kompilator.situs.annotations.BeforeAll @BeforeAll},
 *       {@link no.kompilator.situs.annotations.BeforeEach @BeforeEach},
 *       {@link no.kompilator.situs.annotations.AfterEach @AfterEach},
 *       {@link no.kompilator.situs.annotations.AfterAll @AfterAll}) and test methods
...
public class TestRunner {
     ...
     * (e.g. pass a {@link no.kompilator.situs.spring.SpringInstanceFactory}).
     *
